...
function CandidateCardCommon({ data }) {
  return (
    <div className="w-full flex flex-col items-start justify-center p-3 rounded-lg bg-white border border-transparent hover:border-lighter transition-all duration-200">
      <div className="flex flex-row items-center justify-start gap-2 text-blue opacity-80 mb-1">
        <Icon
          icon={data.icon}
          class_name="text-lg p-2 w-8 h-8 bg-blueBackground rounded-sm"
        />
        <Label
          text={data.label}
