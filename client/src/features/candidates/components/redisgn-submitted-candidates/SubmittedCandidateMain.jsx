...
import {
  ...
  getCandidateInfo,
  updateCandidate,
} from "../../services/submittedCandidates.service.js";
import { searchCandidateService } from "../../services/candidate.service";
...
const SubmittedCandidateMain = () => {
  ...
  const {
    ...
    queryFn: () => searchCandidateService(debouncedSearch),
    enabled: isSearching,
    staleTime: 15_000,
    keepPreviousData: true,
  });
