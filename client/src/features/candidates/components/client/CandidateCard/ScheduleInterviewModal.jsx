...
import { showError, showSuccess } from "../../../../../shared/utils/toastUtils.js";
...
export default function ScheduleInterviewModal({
  ...
  const scheduleHandler = async () => {
    ...
    try {
      ...
      pushNotification({
        reference_id: res.data.application_id,
        user_id: user.id,
        type: "schedule_interview",
        title: `Interview ${isInterview ? "Rescheduled" : "Scheduled"}`,
        message: `An interview has been ${isInterview ? "rescheduled" : "scheduled"} for "${candidateName || "candidate"}" for "${job.job_name || "this job"}".`,
        user_type: "client",
