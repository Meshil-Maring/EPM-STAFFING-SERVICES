...
import {
  deleteClient,
  saveClients,
} from "../services/clientManagement.service";
import {
  Building2,
  X,
  Save,
    ...
    if (name === "Delete Client") {
      ...
      try {
        await saveClients({
          ...
          description: company_form.company_description,
          cin: company_form.registration_number,
          email: company_form.email,
          phone: company_form.phone,
          street: company_form.street,
          city: company_form.city,
          state: company_form.state,
          pin_code: company_form.pin_code,
        });
