...
function ListedJobMiddleInformation({
  icons,
  company,
  currentCandidate,
  job,
  ...
  const contract_type = job?.["contract type"] || "N/A";
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <button
          onClick={() => handleViewDetails(company, job)}
...
export default ListedJobMiddleInformation;
